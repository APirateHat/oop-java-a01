---
revision:
    "2025-11-17": "(C, mos) Make this README smaller and include download script on PS."
    "2025-09-15": "(B, mos) Removed countUpToMaxSumWhile and countUpToMaxSumDoWhile too fuzzy."
...
Do not plain copy code without understanding what the code does. Its a waste of your time to work through this lab if you copy someone else solution. Always make the code "your own".
