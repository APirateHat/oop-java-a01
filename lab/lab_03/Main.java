...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(Lab.assertIt(Answer.class.getMethod("firstChar", String.class), new Object[]{"Mumin"}, 'M'));

        System.out.println(Lab.assertIt(Answer.class.getMethod("lastChar", String.class), new Object[]{"Mumin"}, 'n'));
        ...
        System.out.println(Lab.assertIt(Answer.class.getMethod("reverseString", String.class), new Object[]{"Mumintrollet"}, "tellortnimuM", 1));
        System.out.println(Lab.assertIt(Answer.class.getMethod("reverseString", String.class), new Object[]{"Mikael"}, "leakiM"));

        System.out.println(Lab.assertIt(Answer.class.getMethod("isPalindrom", String.class), new Object[]{" Anna"}, true, 1));
