...
public class Lab {
    ...
    */
    ...
    static public String assertIt(
        ...
        if (expected instanceof int[] && result instanceof int[]) {
            success = Arrays.equals((int[]) expected, (int[]) result);
        } else {
            success = Objects.equals(expected, result);
        }
        ...
        else if (expected != null && result != null && expected.getClass() == result.getClass())
        {
            ...
            else if (expected.getClass() == Character.class && (Character)expected == (Character)result)
            {
                success = true;
            }
        }*/
    ...
    static String argsAsString(Object[] args)
    {
        ...
        for (int i = 0; i < args.length; i++)
        {
            if (args[i].getClass() == String.class)
            {
                ...
                String res = Arrays.deepToString((Object[]) args);
                argStr = res.substring(1, res.length() - 1) + ", ";
            }
            else
            {
                argStr += args[i] + ", ";
    ...
    */
    static public String done ()
    {
        ...
        str += " --------------------------------------------------------------------\n";
        str += "| Points: " + result + "/" + PASS_TOTAL + " (PASS:" + PASS + " HONOUR:" + PASS_W_HONOUR + ")";
        str += " Tests: " + total + " (✅ " + passed + " ❌ " + failed + ")";
        str += "\n| " + pointStr;
        str += "\n| " + feedback(result);
        str += "\n --------------------------------------------------------------------";
